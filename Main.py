    ...
    for user in user_list:
        try:
            ...
            if previous is True:
                ...
                Sent.user_data(api, user, number_tweets, tweets_replies_data, trim, previous=True)
            else:
            ...
            Sent.user_data(api, user, number_tweets, tweets_replies_data, trim, previous=False)
        except IOError:
            if previous is True:
